    ...
    <div style={{ maxWidth: 960, margin: "0 auto" }}>
      ...
      <div className="grid grid-cols-1 md-grid-cols-2 lg-grid-cols-3" style={{ gap: 14, marginBottom: 24 }}>
        {[
          ...
          { label: "Active", value: active.length, icon: "🔧", color: "var(--primary-yellow)" },
          { label: "Avg Progress", value: `${avgProgress}%`, icon: "📊", color: "var(--primary-yellow)" },
        ].map((s, i) => (
            ...
            return (
              <div key={p.id} className="glass-panel" style={{ padding: "18px 22px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: "0.82rem", fontWeight: 700, color: "var(--primary-yellow)", minWidth: 42, textAlign: "right" }}>{p.progress || 0}%</span>
                </div>
