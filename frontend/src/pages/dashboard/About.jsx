...
const TECH_STACK = [
  ...
  { name: "Framer Motion", icon: "🎬", color: "#FFD700" },
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
            <div style={{
              ...
              background: "linear-gradient(135deg, var(--primary-yellow-deep), var(--primary-yellow))",
          ...
          <p style={{ color: "var(--text-secondary)", lineHeight: 1.8, fontSize: "0.92rem", marginTop: 12 }}>
            ...
            better health. <strong style={{ color: "var(--primary-yellow)" }}>Our mission is to help students thrive, not just survive.</strong>
          </p>
        </div>
      </GlassCard>
      ...
      <GlassCard delay={0.4} style={{ padding: "clamp(24px, 4vw, 36px)", marginBottom: 24, textAlign: "center" }}>
        <div style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--primary-yellow)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 16 }}>
          Creator & Developer
        </div>
        <div style={{
        ...
        <a href="mailto:dibyaprakashpatnaik@gmail.com" style={{
          ...
          color: "var(--primary-yellow)", fontSize: "0.85rem", fontWeight: 600,
      ...
      <GlassCard delay={0.5} style={{ padding: "clamp(18px, 3vw, 24px)", marginBottom: 24 }}>
        <div className="grid grid-cols-1 md-grid-cols-3" style={{ gap: 16 }}>
          <div style={{ textAlign: "center", padding: "12px 0" }}>
            ...
            <div style={{ fontSize: "1.1rem", fontWeight: 800, color: "var(--primary-yellow)" }}>2.0.0</div>
          </div>
          ...
          <div style={{ textAlign: "center", padding: "12px 0" }}>
            ...
            <div style={{ fontSize: "1.1rem", fontWeight: 800, color: "var(--primary-yellow)" }}>Web + Mobile</div>
          </div>
        </div>
      </GlassCard>
