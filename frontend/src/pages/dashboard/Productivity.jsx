...
const BAR_COLORS = ["#FFD700", "#FFC107", "#FFEB3B", "#FF8F00", "#FFCA28", "#FFE082", "#FFF176"];
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      <div className="grid grid-cols-1 md-grid-cols-3" style={{ gap: 24 }}>
        <GlassCard delay={0.1} accentColor="#FFC107">
          <div style={{ color: "#FFC107", marginBottom: 8, fontSize: "0.875rem", fontWeight: 600 }}>Avg Study Time</div>
        ...
        <GlassCard delay={0.3} accentColor="#FFD700">
          <div style={{ color: "#FFD700", marginBottom: 8, fontSize: "0.875rem", fontWeight: 600 }}>Consistency</div>
      ...
      <div className="grid grid-cols-1 lg-grid-cols-3" style={{ gap: 24 }}>
        ...
        <GlassCard delay={0.5} style={{ display: "flex", flexDirection: "column" }}>
          ...
          <ul style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <li style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: 12, background: "rgba(20,184,166,0.08)", borderRadius: 8, borderLeft: "3px solid #FFC107" }}>
              <span style={{ display: "flex", alignItems: "center", gap: 12 }}><span style={{ fontSize: "1.25rem" }}>📚</span> Study</span>
              <span style={{ color: "#FFC107", fontWeight: 700 }}>{avgStudy}h/day</span>
            </li>
            ...
            <li style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: 12, background: avgStudy > avgGaming ? "rgba(34,197,94,0.08)" : "rgba(239,68,68,0.08)", borderRadius: 8, borderLeft: `3px solid ${avgStudy > avgGaming ? "#FFD700" : "#ef4444"}` }}>
              <span style={{ display: "flex", alignItems: "center", gap: 12 }}><span style={{ fontSize: "1.25rem" }}>⚖️</span> Ratio</span>
              <span style={{ color: avgStudy > avgGaming ? "#FFD700" : "#ef4444", fontWeight: 700 }}>
