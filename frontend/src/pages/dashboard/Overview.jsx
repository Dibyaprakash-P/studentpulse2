...
const CHART_HEX = ["#FFD700", "#FFC107", "#FFEB3B", "#FF8F00", "#FFE082", "#FFCA28", "#FFF176"];
...
export default function DashboardHome() {
  ...
  const riskColor = riskLevel === "high" ? "var(--danger)" : riskLevel === "moderate" ? "var(--warning)" : "var(--primary-yellow)";
  const riskColorHex = riskLevel === "high" ? "#fb7185" : riskLevel === "moderate" ? "#fbbf24" : "#FFD700";
