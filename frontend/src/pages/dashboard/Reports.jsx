...
function gradeColor(g) {
  ...
  return GRADE_COLORS[g.toUpperCase()] || "var(--primary-yellow)";
}
        ...
        {showForm && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }}
            ...
            <div className="glass-panel" style={{
              ...
              borderLeft: `3px solid ${editingId ? "var(--primary-yellow)" : "var(--primary-yellow)"}`,
            }}>
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
                    ...
                    <label htmlFor="report-file-upload" className="glass-panel" style={{
                      ...
                      color: "var(--primary-yellow)", borderStyle: "dashed",
                      transition: "all 0.2s",
                    }}>
                      📤 Choose Files
                    </label>
      ...
      {subjects.length > 0 && (
        <div style={{ display: "flex", gap: 8, marginBottom: 20, flexWrap: "wrap" }}>
          <button onClick={() => setFilter("All")} style={{
            ...
            color: filter === "All" ? "var(--primary-yellow)" : "var(--text-muted)", fontWeight: filter === "All" ? 600 : 400,
          }}>All</button>
          {subjects.map(s => (
            <button key={s} onClick={() => setFilter(s)} style={{
              ...
              color: filter === s ? "var(--primary-yellow)" : "var(--text-muted)", fontWeight: filter === s ? 600 : 400,
            }}>{s}</button>
          ))}
        </div>
      )}
